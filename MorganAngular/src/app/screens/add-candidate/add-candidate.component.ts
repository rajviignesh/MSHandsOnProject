...
export class AddCandidateComponent implements OnInit {
  ...
  constructor(private _formBuilder: FormBuilder, private api : ApiServiceService, private snackBar: MatSnackBar, private router : Router ) { }
  ...
  saveCandidate(){
    if(this.email.valid){
      ...
      this.api.saveCandidate(this.candDetails).subscribe({
        next: response => {
          console.log(response)
          if(response){
